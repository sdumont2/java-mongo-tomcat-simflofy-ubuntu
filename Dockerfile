...
RUN mkdir -p /var/lib/mongodb /data/configdb /data/db \
	&& chown -R mongodb:mongodb /var/lib/mongodb /data/configdb /data/db
VOLUME /var/lib/mongodb /data/configdb /data/db
